...
public class CSVhandler {
    ...
    public static void exportNormalCSV(int[][] array, boolean printOut) {
        ...
        try {
            String msg = writeToFile(new JFileChooser().getFileSystemView().getDefaultDirectory().toString(), "sudoku_solvable", sb.toString());
    ...
    private static String writeToFile(String path, String filename, String input) throws Exception {
        ...
        if (file.exists() && JOptionPane.showConfirmDialog(null, "Do you want to delete existing sudoku files?") == 0) {
